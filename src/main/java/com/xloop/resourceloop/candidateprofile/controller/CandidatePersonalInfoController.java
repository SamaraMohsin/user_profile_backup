...
public class CandidatePersonalInfoController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CandidatePersonalInfo> updatePersonalInformation(@PathVariable Long id,
            @RequestBody CandidatePersonalInfo personalInformation) {
        CandidatePersonalInfo updatedPersonalInformation = PersonalInfoService.updatePersonalInformation(id,
                personalInformation);
